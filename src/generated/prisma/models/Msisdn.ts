...
// @ts-nocheck 
/*
 * This file exports the `Msisdn` model and its related types.
 *
...
export type MsisdnWhereInput = {
  ...
  city?: Prisma.StringFilter<"Msisdn"> | string
...
export type MsisdnScalarWhereWithAggregatesInput = {
  ...
  city?: Prisma.StringWithAggregatesFilter<"Msisdn"> | string
...
export type MsisdnOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "msisdn" | "sn" | "slotSimbank" | "linkCekKuota" | "noDus" | "kuota" | "usedQuota" | "remainingQuota" | "city" | "lastScrapedAt" | "isExhausted" | "createdAt" | "updatedAt", ExtArgs["result"]["msisdn"]>
...
export interface MsisdnFieldRefs {
  ...
  readonly city: Prisma.FieldRef<"Msisdn", 'String'>
